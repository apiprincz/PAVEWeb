...
const terms = () => {
  return (
    <div>
      <SetLayout>
        <div className={` col-md-8 ml-5 ${Styles.setContainerCustom}`}>
          <h3>Terms of Use</h3>
          <div className={Styles.termContainer}>
            ...
            >
              ...
              <br></br>
              <br></br> Welcome to KJK Africa (“Company”, “we”, “our”, “us”)!
              <br></br>
              <br></br>
              These Terms of Service (“Terms”, “Terms of Service”) govern your
              use of our website located at <span> Pave.ng </span> (together or
              individually “Service”) operated by <span> KJK Africa.</span>
              <br></br>
              <br></br>
              Our Privacy Policy also governs your use of our Service and
              explains how we collect, safeguard and disclose information that
              results from your use of our web pages.<br></br>
              <br></br> Your agreement with us includes these Terms and our
              Privacy Policy (“Agreements”). You acknowledge that you have read
              and understood Agreements, and agree to be bound of them.{" "}
              <br></br>
              <br></br>If you do not agree with (or cannot comply with)
              Agreements, then you may not use the Service, but please let us
              know by emailing at support@kjk.africa so we can try to find a
              ...
              emailing at support@kjk.africa.
              <br></br>
              <br></br>
              ...
              <br></br>
              <br></br> You represent and warrant that: (i) you have the legal
              right to use any card(s) or other payment method(s) in connection
              with any Purchase; and that (ii) the information you supply to us
              is true, correct and complete.<br></br>
              <br></br> We may employ the use of third party services for the
              ...
              Policy.<br></br>
              <br></br> We reserve the right to refuse or cancel your order at
              any time for reasons including but not limited to: product or
              service availability, errors in the description or price of the
              product or service, error in your order or other reasons.<br></br>
              <br></br> We reserve the right to refuse or cancel your order if
              fraud or an unauthorized or illegal transaction is suspected.
              <br></br>
              <br></br>
              <span>4. Contests, Sweepstakes and Promotions</span>
              <br></br>
              <br></br> Any contests, sweepstakes or other promotions
              ...
              <br></br>
              <br></br>
              We issue refunds for Contracts within <span> 30 days </span> of
              ...
              reliability, and appropriateness.<br></br>
              <br></br>
              ...
              <br></br>
              <br></br> You retain any and all of your rights to any Content you
              ...
              <br></br>
              <br></br>
              <span> KJK Africa </span>has the right but not the obligation to
              monitor and edit all Content provided by users.<br></br>
              <br></br>
              In addition, Content found on or through this Service are the
              property of KJK Africa or used with permission. You may not
              ...
              <br></br>
              <br></br> You may use Service only for lawful purposes and in
              accordance with Terms. You agree not to use Service:<br></br>
              <br></br> 0.1. In any way that violates any applicable national or
              international law or regulation.<br></br>
              <br></br> 0.2. For the purpose of exploiting, harming, or
              attempting to exploit or harm minors in any way by exposing them
              to inappropriate content or otherwise. <br></br>
              <br></br>0.3. To transmit, or procure the sending of, any
              ...
              <br></br> 0.5. In any way that infringes upon the rights of
              others, or in any way is illegal, threatening, fraudulent, or
              harmful, or in connection with any unlawful, illegal, fraudulent,
              or harmful purpose or activity.<br></br>
              <br></br> 0.6. To engage in any other conduct that restricts or
              inhibits anyone’s use or enjoyment of Service, or which, as
              determined by us, may harm or offend Company or users of Service
              or expose them to liability.<br></br>
              <br></br> Additionally, you agree not to:<br></br>
              <br></br> 0.1. Use Service in any manner that could disable,
              ...
              time activities through Service.<br></br>
              <br></br> 0.2. Use any robot, spider, or other automatic device,
              process, or means to access Service for any purpose, including
              monitoring or copying any of the material on Service.<br></br>
              <br></br>
              ...
              <br></br>0.4. Use any device, software, or routine that interferes
              with the proper working of Service.<br></br>
              <br></br> 0.5. Introduce any viruses, trojan horses, worms, logic
              bombs, or other material which is malicious or technologically
              harmful. <br></br>
              <br></br>0.6. Attempt to gain unauthorized access to, interfere
              ...
              to Service.<br></br>
              <br></br> 0.7. Attack Service via a denial-of-service attack or a
              distributed denial-of-service attack.<br></br>
              <br></br> 0.8. Take any action that may damage or falsify Company
              rating.<br></br>
              <br></br> 0.9. Otherwise attempt to interfere with the proper
              ...
              exclusive property of KJK Africa and its licensors. Service is
              ...
              product or service without the prior written consent of KJK
              Africa.
              <br></br>
              <br></br>
              ...
              (“Infringement”) of any person or entity. <br></br>
              <br></br>If you are a copyright owner, or authorized on behalf of
              one, and you believe that the copyrighted work has been copied in
              a way that constitutes copyright infringement, please submit your
              claim via email to support@kjk.africa, with the subject line:
              ...
              <br></br>
              <br></br>You may be held accountable for damages (including costs
              ...
              <br></br>0.1. an electronic or physical signature of the person
              authorized to act on behalf of the owner of the copyright’s
              interest;<br></br>
              <br></br> 0.2. a description of the copyrighted work that you
              claim has been infringed, including the URL (i.e., web page
              address) of the location where the copyrighted work exists or a
              copy of the copyrighted work; <br></br>
              <br></br>0.3. identification of the URL or other specific location
              on Service where the material that you claim is infringing is
              located;<br></br>
              <br></br> 0.4. your address, telephone number, and email address;
              <br></br>
              <br></br> 0.5. a statement by you that you have a good faith
              belief that the disputed use is not authorized by the copyright
              owner, its agent, or the law;<br></br>
              <br></br> 0.6. a statement by you, made under penalty of perjury,
              ...
              <br></br> You can contact our Copyright Agent via email at
              support@kjk.africa. <br></br>
              <br></br>
              <span> 13. Error Reporting and Feedback</span>
              <br></br>
              <br></br> You may provide us either directly at support@kjk.africa
              ...
              <br></br>
              <br></br>
              <span> 14. Links To Other Web Sites</span>
              <br></br>
              <br></br>
              Our Service may contain links to third party web sites or services
              that are not owned or controlled by KJK Africa.<br></br>
              <br></br> KJK Africa has no control over, and assumes no
              ...
              <br></br>
              <br></br>For example, the outlined Terms of Use have been created
              ...
              store or app.<br></br>
              <br></br> YOU ACKNOWLEDGE AND AGREE THAT COMPANY SHALL NOT BE
              ...
              OR THROUGH ANY SUCH THIRD PARTY WEB SITES OR SERVICES. <br></br>
              <br></br>WE STRONGLY ADVISE YOU TO READ THE TERMS OF SERVICE AND
              PRIVACY POLICIES OF ANY THIRD PARTY WEB SITES OR SERVICES THAT YOU
              VISIT.<br></br>
              <br></br>
              <span> 15. Disclaimer Of Warranty</span>
              <br></br>
              <br></br>
              ...
              <br></br> NEITHER COMPANY NOR ANY PERSON ASSOCIATED WITH COMPANY
              ...
              MEET YOUR NEEDS OR EXPECTATIONS.<br></br>
              <br></br> COMPANY HEREBY DISCLAIMS ALL WARRANTIES OF ANY KIND,
              ...
              <br></br> THE FOREGOING DOES NOT AFFECT ANY WARRANTIES WHICH
              CANNOT BE EXCLUDED OR LIMITED UNDER APPLICABLE LAW. <br></br>
              <br></br>
              ...
              to Service immediately, without prior notice or liability, under
              our sole discretion, for any reason whatsoever and without
              limitation, including but not limited to a breach of Terms.{" "}
              <br></br>
              <br></br>If you wish to terminate your account, you may simply
              discontinue using Service.<br></br>
              <br></br> All provisions of Terms which by their nature should
              ...
              regarding Service.<br></br>
              <br></br>
              <span>19. Changes To Service </span>
              <br></br>
              <br></br>We reserve the right to withdraw or amend our Service,
              ...
              <br></br>
              <br></br>
              <span> 20. Amendments To Terms</span>
              <br></br>
              <br></br>
              We may amend Terms at any time by posting the amended terms on
              this site. It is your responsibility to review these Terms
              periodically. <br></br>
              <br></br> Your continued use of the Platform following the posting
              of revised Terms means that you accept and agree to the changes.
              You are expected to check this page frequently so you are aware of
              any changes, as they are binding on you.<br></br>
              <br></br> By continuing to access or use our Service after any
              revisions become effective, you agree to be bound by the revised
              terms. If you do not agree to the new terms, you are no longer
              authorized to use Service.<br></br>
              <br></br>
              <span> 21. Waiver And Severability </span>
              <br></br>
              <br></br>
              ...
              shall not constitute a waiver of such right or provision.<br></br>
              <br></br> If any provision of Terms is held by a court or other
              ...
              technical support by email: support@kjk.africa. <br></br>
              <br></br>These Terms of Service were created for Pave.ng by
              PolicyMaker.io on 2021-02-10.
            </p>
          </div>
        </div>
      </SetLayout>
